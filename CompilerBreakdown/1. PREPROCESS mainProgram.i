...
# 119 "/usr/local/include/wiringPi.h" 3
extern const char *piModelNames [21] ;
extern const char *piRevisionNames [16] ;
extern const char *piMakerNames [16] ;
extern const int piMemorySize [ 8] ;
# 145 "/usr/local/include/wiringPi.h" 3
...
# 193 "/usr/local/include/wiringPi.h" 3
...
# 10 "mainProgram.c" 2
# 1 "/usr/local/include/wiringPiI2C.h" 1 3
# 29 "/usr/local/include/wiringPiI2C.h" 3
...
# 11 "mainProgram.c" 2
# 1 "/usr/local/include/pcf8574.h" 1 3
# 29 "/usr/local/include/pcf8574.h" 3
extern int pcf8574Setup (const int pinBase, const int i2cAddress) ;
# 12 "mainProgram.c" 2
# 1 "/usr/local/include/lcd.h" 1 3
# 33 "/usr/local/include/lcd.h" 3
...
int main()
{
    ...
    pcf8574Setup(64,pcf8574_address);
    for(i=0;i<8;i++){
        pinMode(64 +i,
# 331 "mainProgram.c" 3
                      1
...
# 334 "mainProgram.c"
 ...
 lcdhd = lcdInit(2,16,4,64 +0,64 +2,64 +4,64 +5,64 +6,64 +7,0,0,0,0);
    if(lcdhd == -1){
